...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**") // 匹配所有路径
                .allowedOrigins("http://localhost:8085", "http://localhost:5000","http://localhost:8000","http://121.36.44.77:8090 ","http://121.36.44.77:8085","http://121.36.44.77:8000","http://localhost:8087") // 允许的来源，可以是具体域名或通配符 "*"
